<?php
    ...
    if (!isset($_SESSION["username"])) {
        echo "<h1>Anda harus login dulu </h1><br><a href='../index.php'>Click Here</a>";
        exit;
    }
    ...
    if ($level != 2) {
        echo "<h1>Maaf, Anda Tidak Mempunyai Akses pada Halaman Pegawai!</h1>";
        exit;
    }
